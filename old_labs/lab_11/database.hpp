...
class DataBase
{
        // Создаём массив из элементов "cc"
        // через агрегацию
        ComputerCase cc[Max];
    ...
    public:
        ...
        // Метод добавления элемента в "cc"
        ...
        // Метод вывода на экран всех имеющихся элементов в "DataBase"
