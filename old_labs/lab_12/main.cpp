...
int main()
{
    ...
    // Проверим метод для установкий значения false
    cout << "----------------------------" << endl;
    // cout << "Инвертируем у элемента №3 значение bnum." << endl;
    ...
    cout << "----------------------------" << endl;
    B b2;
    // и скопируем в него данные из ранее заполненного объекта
    b2 = b;

    // Удалим элемент под номером 7
    b2.del(7);
